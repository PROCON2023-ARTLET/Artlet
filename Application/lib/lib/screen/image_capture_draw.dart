...
class _DrawingScreenState extends State<DrawingScreen> {
  ...
  bool isCaptured = false; // Add the isCaptured flag
    ...
    try {
      ...
      if (imageUint8List != null) {
        ...
        if (result['isSuccess']) {
          ...
          setState(() {
            isCaptured =
                true; // Set isCaptured to true after capturing the image
          });
        } else {
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: () {
              if (!isCaptured) {
                _captureScreen(); // Capture the image if not captured
              }
              Navigator.push(
                context,
            ...
            tooltip: isCaptured ? 'View Score' : 'Capture and View Score',
          ),
        ],
      ),
      body: Screenshot(
